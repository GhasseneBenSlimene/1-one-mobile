...
public class EvaluationSiteWithDetailsDTO {
    private long id;
    private Site site;
    ...
    public EvaluationSite toEvaluationSite() {
        EvaluationSite evaluationSite = new EvaluationSite();
        evaluationSite.setId(this.id);
        evaluationSite.setSiteId(this.site.getId());
        evaluationSite.setEvaluationId(this.evaluation.getId());
